...
function timer(id, deadline) {
   ...
   function getTimeRemaining(endtime) {
     ...
     if (t <= 0) {
       timer.innerHTML = '<div class="finish">Акция закончилась!</div>';
     } else {
     ...
     const date = { t, days, hours, minutes, seconds };
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', '2023-09-30');
